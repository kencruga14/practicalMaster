...
const routes: Routes = [
  ...
  {path: 'administrador', component: AdministradorComponent, canActivate: [RolGuard]},
    {path: 'urbanizacion', component: UrbanizacionComponent, canActivate: [RolGuard]},
    {path: 'etapa', component: EtapaComponent, canActivate: [RolGuard]},
    {path: 'adminetapa', component: AdminetapaComponent, canActivate: [RolGuard]},
    {path: 'market', component: MarketComponent, canActivate: [RolGuard]},
    {path: 'publicidad', component: PublicidadComponent, canActivate: [RolGuard]},
